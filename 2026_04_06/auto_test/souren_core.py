...
class PythonScriptExecutor:
    ...
    def execute_script(self, file_path: str, parameters: Dict = None,
        ...
        class APWrapper:
            ...
            def send(self, command, extract_index=None, should_extract=False, chart_title=None, x_label=None, separate_loop_chart=False):
                self.executor._current_command_is_query = False
                return self.executor._execute_ap_command(command, extract_index, should_extract, chart_title, x_label, separate_loop_chart)
            def query(self, command, extract_index=None, should_extract=False, chart_title=None, x_label=None, separate_loop_chart=False):
    ...
    def _execute_ap_command(self, command: str, extract_index=None, should_extract=False,
                             chart_title=None, x_label=None, separate_loop_chart=False) -> str:
        ...
        if should_extract and extract_index is not None:
            ...
            if extracted is not None:
                ...
                print(f"  📊 提取数据: {extracted} (标题: {chart_title}, 横坐标: {x_label}, 单独图表: {separate_loop_chart})")
