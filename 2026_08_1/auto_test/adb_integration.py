...
class ADBFlightModeController:
    def __init__(self, adb_path=None):
        ...
        self._safe_cwd = self._resolve_safe_cwd()
    ...
    def _resolve_safe_cwd(self) -> str:
        if self.adb_path and self.adb_path != "adb" and os.path.exists(self.adb_path):
            return os.path.dirname(os.path.abspath(self.adb_path))
